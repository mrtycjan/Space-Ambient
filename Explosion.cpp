...
Explosion::Explosion(void)
{
	...
	texture[5].loadFromFile("data/textures/exp5.png");
	texture[6].loadFromFile("data/textures/exp6.png");
	texture[7].loadFromFile("data/textures/exp7.png");
	texture[8].loadFromFile("data/textures/exp8.png");
	texture[9].loadFromFile("data/textures/exp9.png");
